...
# load a wine data
wine_path = "05.WineQuality/winequality-white.csv"
wineq_numpy = np.loadtxt(wine_path, dtype=np.float32, delimiter=";", skiprows=1)
wineq = torch.from_numpy(wineq_numpy)

data = wineq[:, :-1]    # data : for wine analysis
...
seq_model = nn.Sequential(OrderedDict([
    ('hidden1_linear', nn.Linear(11, 256)),
    ('hidden1_activation', nn.LeakyReLU()),
    ('hidden2_linear', nn.Linear(256, 256)),
    ('hidden2_activation', nn.LeakyReLU()),
    ('hidden3_linear', nn.Linear(256, 128)),
...
plt.savefig("05.WineQuality/img/hidden3#256#256#128_epoch500.png", format="png")